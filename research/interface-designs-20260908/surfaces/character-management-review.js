...
(() => {
      ...
      <div class="drawer-slice" data-panel="proposal" role="region" aria-label="角色管理">
        ...
        <div class="tools" data-native="charListFixedTop">
          <div class="action-bar" data-native="rm_button_bar">
            <button type="button" class="tool create-tool" data-action="create" title="新建角色" aria-label="新建角色"><i class="fa-solid fa-user-plus" aria-hidden="true"></i><span>新建</span></button>${iconButton('file')}${iconButton('url')}${iconButton('group')}
  ...
  function render(rebuildList = true) {
    ...
    sort.dispatchEvent(new Event('management-sort:sync'));
    ...
    pageSize.dispatchEvent(new Event('management-page-size:sync'));
